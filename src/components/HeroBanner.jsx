  ...
  return (
    <>
      <section className="mx-auto max-w-980 w-full box-border md:h-[calc(100vh - 40px)] h-screen  md:pt-40 pt-20 relative z-10 min-h-831">
        <div className="flex items-center flex-col">
          <div className="px-4">
            <h1 className="font-main font-bold text-alt-white text-4xl md:text-5xl 2xl:text-9xl text-center uppercase">
              ...
              <span className="italic text-lite-passive">HO</span>P D
              <span className="italic text-lite-passive">E</span>
              MO
            </h1>
            ...
            <div className="flex justify-center 2xl:justify-end gap-5 mt-5 2xl:mt-10  ">
              ...
              <button className="btn bg-purple-300 hover:bg-purple-400 text-dark-passive px-8 font-sub text-lg 2xl:text-xl capitalize">
                join
              </button>
            </div>
          </div>
        ...
        <div className="flex justify-end md:mt-[-10rem]  mt-[3rem]">
